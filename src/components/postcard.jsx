...
export default class Postcard extends Component {
    render() {
        const { employees, deletehandler } = this.props;
                    ...
                    <tbody>
                        {employees.map((emp, index) => (
                            <tr key={index}>
                                ...
                                <td>{emp.skill}</td>
                                <td>
                                    <a href={emp.profileurl} target="_blank" rel="noopener noreferrer">View</a>
                                </td>
                                <td>
                                    <button className='btn btn-danger btn-sm' onClick={() => deletehandler(index)}>Delete</button>  
                                                                        <button className='btn btn-danger btn-sm' onClick={() => updatehandler(index)}>Update</button>                         
